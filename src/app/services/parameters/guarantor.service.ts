...
export class GuarantorService {
  ...
  getGuarantor(filter: any): Observable<any> {
    ...
    return this.http.get<boolean>(`${this.urlLogic}/guarantor?filter=${queryParams.toString()}/client`)
  }
  ...
  editGuarantor(data: GuarantorModel): Observable<any> {
    return this.http.put<boolean>(`${this.urlLogic}/guarantor/${data.id}`, data)
  }
